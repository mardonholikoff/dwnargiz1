      ...
      <div className="relative w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden my-8">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 max-h-[80vh] overflow-y-auto">
          ...
          <div className="p-4 rounded-xl bg-slate-950/50 border border-slate-800/80 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Km (Mileage) - Mandatory for Oil, Optional for Spare Parts */}
              <div>
                <label className="block text-xs font-medium text-slate-300 mb-1.5 flex items-center justify-between">
                  <span>
                    ...
                    {isOilChanged ? (
                      ...
                      <span className="text-blue-400/80 font-normal text-[11px]">(Ixtiyoriy)</span>
                    )}
                  </span>
                  {!isOilChanged && isPartSold && (
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={isOilChanged ? "125000" : "Ixtiyoriy (masalan: 125000)"}
